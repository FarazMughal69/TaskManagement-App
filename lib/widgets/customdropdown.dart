...
class CustomDropdown<T> extends StatefulWidget {
  ...
  // ddl initial value when the screen in first time show
...
class DropdownItem<T> extends StatelessWidget {
  ...
  DropdownItem({Key? key, this.value, required this.child}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return child;
  }
...
//   final LayerLink _layerLink = LayerLink();
//   late String ddlSelectedTxt = 'Todo';
//   OverlayEntry _createOverlayEntry() {
//     RenderBox renderBox = context.findRenderObject() as RenderBox;
//     var size = renderBox.size;
//     var offset = renderBox.localToGlobal(Offset.zero);
...
//             //     InkWell(
//             //       onTap: () {
//             //         ddlSelectedTxt = 'Faraz';
//             //         setState(() {});
//             //       },
//             //       child: const Text('Faraz'),
//             //     ),
//             //     InkWell(
//             //       onTap: () {
//             //         ddlSelectedTxt = 'In Progress';
//             //         setState(() {});
//             //       },
